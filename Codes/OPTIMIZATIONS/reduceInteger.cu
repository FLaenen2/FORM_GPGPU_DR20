...
int main(int argc, char **argv)
{
    ...
    printf("reduceNeighboredGmem: %d <<<grid %d block %d>>> time %g\n", gpu_sum, grid.x,
           block.x, timer.Elapsed());
    ...
    printf("reduceNeighboredSmem: %d <<<grid %d block %d>>> time %g\n", gpu_sum, grid.x,
           block.x, timer.Elapsed());
    ...
    printf("reduceGmem          : %d <<<grid %d block %d>>> time %g\n", gpu_sum, grid.x,
           block.x, timer.Elapsed());
    ...
    printf("reduceSmem          : %d <<<grid %d block %d>>> timer %g\n", gpu_sum, grid.x,
           block.x, timer.Elapsed());
    ...
    printf("reduceSmemDyn       : %d <<<grid %d block %d>>> time %g\n", gpu_sum, grid.x, block.x, timer.Elapsed());
    ...
    printf("reduceGmemUnroll4   : %d <<<grid %d block %d>>> time %g\n", gpu_sum,
            grid.x / 4, block.x, timer.Elapsed());
    ...
    printf("reduceSmemUnroll4   : %d <<<grid %d block %d>>> time %g\n", gpu_sum,
            grid.x / 4, block.x, timer.Elapsed());
    ...
    printf("reduceSmemDynUnroll4: %d <<<grid %d block %d>>> time %g\n", gpu_sum,
            grid.x / 4, block.x, timer.Elapsed());
